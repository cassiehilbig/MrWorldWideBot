...
class JumpTransition(Transition):
    """
    Transition subclass that clears the user's state list and replaces it with a new state array.
    """
    def __init__(self, messages, new_states):
        super(JumpTransition, self).__init__(messages, None)
